    ...
    public class AlunoRepositorioSql : IRepositorio
    {
        ...
        public List<Aluno> Todos()
        {
            ...
            using (var cnn = new SqlConnection(this.stringConexaoSql()))
            {
                ...
                {
                    Console.WriteLine($"Ops ... Ocorreu um erro de validacao {erro.Message}");
                }
                catch (Exception erro)
                {
                    Console.WriteLine($"Ops ... Ocorreu um erro de conexao {erro.Message}");
                }
                finally
                {
                    cnn.Close();
